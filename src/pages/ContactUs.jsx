    ...
    <div className="overflow-hidden relative">
      ...
      <div className="relative min-h-screen pt-24 bg-blue-400">
        ...
        <header className="relative z-10 text-center mb-6 px-4">
          <h1 className="text-6xl text-white font-bold" style={{ textShadow: "2px 2px 4px blue, 4px 4px 6px rgba(0, 0, 0, 0.6)" }}>
            CONTACT US
          </h1>
      ...
      <div className="mt-20">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 text-center text-blue-400" style={{ textShadow: "2px 2px 4px black, 4px 4px 6px rgba(0, 0, 0, 0.6)" }}>
